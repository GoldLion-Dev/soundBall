...
audios[1] = document.getElementById("audio_1");
audios[2] = document.getElementById("audio_2");
audios[3] = document.getElementById("audio_3");
audios[4] = document.getElementById("audio_4");
audios[5] = document.getElementById("audio_5");
audios[6] = document.getElementById("audio_6");
audios[7] = document.getElementById("audio_7");
...
class Stick {
  ...
  half_space() {
    ...
    let delta =
      (b.pos.x - a.pos.x) * (p.y - a.pos.y) -
      (b.pos.y - a.pos.y) * (p.x - a.pos.x);
    let sound = audios[random(8)];
...
class Rope {
  ...
  draw(ctx) {
    ...
    this.sticks.forEach((stick) => {
      stick.draw(ctx, this.strokeColor);
    });
...
class App {
  ...
  createRopes() {
    ...
    for (let i = 0; i < TOTAL + 1; i++) {
      const x = i * 15;
      const y = 0;
      const gap = randomNumBetween(App.height * 0.07, App.height * 0.08);
      const segments = 12;
      const r = random(255);
      const g = random(255);
      const b = random(255);
